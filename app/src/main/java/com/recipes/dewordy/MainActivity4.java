...
//        headingText.setTypeface(font);
		...
		heading_tv = (ImageView) findViewById(R.id.heading_tv);
		heading_tv.setOnClickListener(new View.OnClickListener() {
			@Override
	...
	private void findViews() {
		headingText = (ImageView) findViewById(R.id.heading_tv);
		       ...
		       .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
		           public void onClick(DialogInterface dialog, int id) {
		        	   ...
		        	   if (!TextUtils.isEmpty(msgEdit.getText())) {
		        		   ...
		        		   Toast.makeText(MainActivity4.this, "Enter a message", Toast.LENGTH_SHORT).show();
		        	   }
		           }
		       })
