...
import com.recipes.dewordy.adapter.CustomPagerAdapter2;
...
//        tabLayout.addTab(tabLayout.newTab().setText("Chat Room"));
        ...
        final CustomPagerAdapter2 adapter = new CustomPagerAdapter2(MainActivity3.getInstance().getSupportFragmentManager(), tabLayout.getTabCount());
