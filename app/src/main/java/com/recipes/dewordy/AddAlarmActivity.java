...
import com.recipes.dewordy.model2.Alarm;
import com.recipes.dewordy.model2.AlarmMsg;
import com.recipes.dewordy.model2.AlarmTime;
import com.recipes.dewordy.model2.DbHelper2;
...
//		timePicker.setCurrentMinute(state.getInt("min"));
	...
	public void create(View v) {
		...
		case 0: //one time
			alarm.setFromDate(DbHelper2.getDateStr(datePicker.getYear(), datePicker.getMonth()+1, datePicker.getDayOfMonth()));
			alarmId = alarm.persist(db);

			alarmTime.setAt(DbHelper2.getTimeStr(timePicker.getCurrentHour(), timePicker.getCurrentMinute()));
			...
			DatePickerDialog.OnDateSetListener dateListener =
			    new DatePickerDialog.OnDateSetListener() {
					public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
						String txt = DbHelper2.getDateStr(year, monthOfYear+1, dayOfMonth);
						try {
							txt = sdf.format(DbHelper2.sdf.parse(txt));
						} catch (ParseException e) {}
