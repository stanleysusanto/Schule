...
////            @Override
////            public void onClick(View v) {
////                MainActivity6.getInstance().changeFragment(FragmentsAvailable.GeneralList);
////            }
////        });
////        dis3.setOnClickListener(new View.OnClickListener() {
////            @Override
////            public void onClick(View v) {
////                MainActivity6.getInstance().changeFragment(FragmentsAvailable.DailyDevotion);
////            }
////        });
////        dis4.setOnClickListener(new View.OnClickListener() {
////            @Override
////            public void onClick(View v) {
////                MainActivity6.getInstance().changeFragment(FragmentsAvailable.AbsenPage);
////            }
////        });
////        dis5.setOnClickListener(new View.OnClickListener() {
////            @Override
////            public void onClick(View v) {
////                MainActivity6.getInstance().changeFragment(FragmentsAvailable.RekapNilai);
////            }
////        });
...
//
//                customAdapter = new CustomExpandAdapter(MainActivity6.this, listParent, listDataChild);
...
//            menu.findItem(R.id.namefor_menu).setTitle(SharedPreference.getusername(MainActivity6.this));
//        } else {
...
////                Toast.makeText(getApplicationContext(),"sd",Toast.LENGTH_LONG).show();
//                Bundle args = new Bundle();
//                MainActivity6.getInstance().changeFragment(FragmentsAvailable.Profile, args);
...
////                startActivity(i);
//                args = new Bundle();
//                MainActivity6.getInstance().changeFragment(FragmentsAvailable.AboutApp, args);
//                return true;
//            case R.id.login:
////                if(LoginState.getUsername() == null) {
...
//            case R.id.help:
//                args = new Bundle();
//                MainActivity6.getInstance().changeFragment(FragmentsAvailable.Help, args);
