...
import com.recipes.dewordy.fragment.CategoryFragment.FirstFragment2;
...
//    private FloatingActionButton fab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(id2){
            ...
            MainActivity.getInstance().changeFragment(FragmentsAvailable.FIFTH_FRAGMENT, args);
        }
...
//        });
        ...
        mTitle2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bundle args = new Bundle();
                args.putInt("id", 0);
                MainActivity.getInstance().changeFragment(FragmentsAvailable.FIRST_FRAGMENT);
            }
        });
...
//                }
                ...
                customAdapter = new CustomExpandAdapter(MainActivity.this, listParent, listDataChild);
...
//            menu.findItem(R.id.settings2).setVisible(true);
            ...
            menu.findItem(R.id.namefor_menu).setVisible(true);
            menu.findItem(R.id.namefor_menu).setTitle(SharedPreference.getusername(MainActivity.this));
        } else {
...
//                Toast.makeText(getApplicationContext(),"sd",Toast.LENGTH_LONG).show();
                Bundle args = new Bundle();
                MainActivity.getInstance().changeFragment(FragmentsAvailable.Profile, args);
...
////                startActivity(i);
//                args = new Bundle();
//                MainActivity.getInstance().changeFragment(FragmentsAvailable.AboutApp, args);
//                return true;
            case R.id.login:
//                if(LoginState.getUsername() == null) {
//                    login.setVisible(false);
//                }
                Intent w = new Intent(MainActivity.this, LoginActivity.class);
                startActivity(w);
                return true;
            case R.id.profile:
...
//                }
                Intent z = new Intent(MainActivity.this, SignupActivity.class);
                startActivity(z);
                return true;
            case R.id.notification:
                Intent q = new Intent(MainActivity.this, LoginActivity.class);
                startActivity(q);
                return true;
            case R.id.request:
                if(SharedPreference.getusername(MainActivity.this).length() == 0) {
                    ...
                    Intent e = new Intent(MainActivity.this, Request.class);
                    startActivity(e);
                }
                return true;
//            case R.id.howto:
...
//                return true;
            case R.id.help:
                args = new Bundle();
                MainActivity.getInstance().changeFragment(FragmentsAvailable.Help, args);
...
//        startActivity(search);
        ...
        MainActivity.getInstance().changeFragment(FragmentsAvailable.Searchroom, args);
        InputMethodManager imm = (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.hideSoftInputFromWindow(view.getWindowToken(), 0);
        mSearchView.hide();
